...
class OpenFilterLineage:
    def __init__(self, client=None, producer="https://github.com/PlainsightAI/openfilter/tree/0.1.2/openfilter/lineage", interval=10, facets={}, filter_name: str = None, job=None):
        ...
        self.producer = os.getenv("OPENFILTER_LINEAGE_PRODUCER") or producer
        ...
        self.namespace = os.getenv("OPENLINEAGE_NAMESPACE", "Openfilter")
        ...
        try:
            ...
            run_facets = {
                "openfilter": {
                    ...
                    "_schemaURL": "https://github.com/PlainsightAI/openfilter/schema/openfilterConfigFacet.json",
                    **self.create_dynamic_facets_from_dict(data_to_use or {})
                }
            }
            ...
            inputs = [Dataset(namespace=self.namespace, name=self.filter_model)] if self.filter_model else []
    ...
    def emit_start(self, facets):
        ...
        self.filter_model = os.getenv(self.filter_name.upper() + "_MODEL_NAME") if self.filter_name else None
        self.job.name = self.filter_name
        self.facets = facets
